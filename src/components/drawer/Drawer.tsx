...
const chargeBacks = [
  ...
  },
  {
    id: uuidv4(),
    title: "Pending",
    route: "/chargebacks/pending",
    icon: <PendingIcon />,
  },
  {
    id: uuidv4(),
    title: "Awaiting Response",
    route: "/chargebacks/awaiting_response",
    icon: <ArrowUpwardIcon />,
  },
  {
    id: uuidv4(),
    title: "Won",
    route: "/chargebacks/won",
    icon: <EmojiEventsIcon />,
  },
  {
    id: uuidv4(),
    title: "Lost",
    route: "/chargebacks/lost",
    icon: <ErrorIcon />,
  },
];
...
export default function MiniDrawer() {
  ...
  if (pathname.toLowerCase() === "/signup" || pathname.toLowerCase() === "/signin" || pathname.toLowerCase() === "/individual_signup") {
    return <div></div>;
  }
  if (pathname.toLowerCase() === "/business/signup" || pathname.toLowerCase() === "/ngo/signup") {
    return <div></div>;
  }
